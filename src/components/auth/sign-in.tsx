...
import { ComponentType, ReactNode, type SyntheticEvent, useState } from "react";
...
export function SignIn({
  ...
  const Captcha = plugins.find((plugin) => plugin.captchaComponent)
    ?.captchaComponent as ReactNode | null;
              ...
              <FieldGroup>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {plugins.flatMap((plugin) => {
                    const authButtons = Array.isArray(plugin.authButtons)
                      ? plugin.authButtons
                      : [];

                    return authButtons.map(
                      (AuthButton: ComponentType<any>, index: number) => (
                        <AuthButton
